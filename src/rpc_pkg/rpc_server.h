...
public:
     ...
     */
    virtual Result
        HandleCall(const char* strRequest, size_t nRequestSize, IResponse& oResponse) = 0;
};
...
public:
     ...
     * @return Standard result.
     */
    virtual Result RegisterRPCObject(const char* strName, IRPCObject* pObject) = 0;
     ...
     * @return Standard result.
     */
    virtual Result UnregisterRPCObject(const char* strName) = 0;
};
